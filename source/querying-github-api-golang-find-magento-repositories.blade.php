<!--
{{ $page_title = 'Querying the Github API with Golang to find all Magento Repositories' }}
...
@include('_partials.jumbotron', ['main_msg' => 'Querying the Github API with Golang to find all Magento Repositories', 'sub_txt' => 'Posted on September 10, 2014 at 4:14 am'])
