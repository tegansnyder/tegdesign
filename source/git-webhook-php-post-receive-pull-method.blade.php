<!--
{{ $page_title = 'Git WebHook PHP Post Receive Pull Method' }}
...
@include('_partials.jumbotron', ['main_msg' => 'Git WebHook PHP Post Receive Pull Method', 'sub_txt' => 'Posted on June 27, 2012 at 10:01 pm'])
